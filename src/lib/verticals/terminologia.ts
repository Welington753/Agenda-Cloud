...
const TERMINOLOGIA_POR_CATEGORIA: Record<CategoriaNegocio, Terminologia> = {
  ...
  terapeuta: {
    estabelecimento: { singular: "Consultório", plural: "Consultórios", artigo: "o" },
    profissional: { singular: "Terapeuta", plural: "Terapeutas", artigo: "o" },
    consumidor: { singular: "Cliente", plural: "Clientes", artigo: "o" },
    servico: { singular: "Sessão", plural: "Sessões", artigo: "a" },
    agendamento: { singular: "Sessão", plural: "Sessões", artigo: "a" },
    equipe: "Terapeutas",
  },
  massagem: {
    estabelecimento: { singular: "Espaço", plural: "Espaços", artigo: "o" },
    profissional: { singular: "Massoterapeuta", plural: "Massoterapeutas", artigo: "o" },
    consumidor: { singular: "Cliente", plural: "Clientes", artigo: "o" },
    servico: { singular: "Sessão", plural: "Sessões", artigo: "a" },
    agendamento: { singular: "Sessão", plural: "Sessões", artigo: "a" },
    equipe: "Massoterapeutas",
  },
  pilates_yoga: {
    estabelecimento: { singular: "Estúdio", plural: "Estúdios", artigo: "o" },
    profissional: { singular: "Instrutor", plural: "Instrutores", artigo: "o" },
    consumidor: { singular: "Aluno", plural: "Alunos", artigo: "o" },
    servico: { singular: "Aula", plural: "Aulas", artigo: "a" },
    agendamento: { singular: "Aula", plural: "Aulas", artigo: "a" },
    equipe: "Instrutores",
  },
  consultor: {
    estabelecimento: { singular: "Consultoria", plural: "Consultorias", artigo: "a" },
    profissional: { singular: "Consultor", plural: "Consultores", artigo: "o" },
    consumidor: { singular: "Cliente", plural: "Clientes", artigo: "o" },
    servico: { singular: "Serviço", plural: "Serviços", artigo: "o" },
    agendamento: { singular: "Sessão", plural: "Sessões", artigo: "a" },
    equipe: "Consultores",
...
export const CATEGORIAS_NEGOCIO: { valor: CategoriaNegocio; rotulo: string }[] = [
  ...
  { valor: "terapeuta", rotulo: "Terapia" },
  { valor: "massagem", rotulo: "Massoterapia" },
  { valor: "pilates_yoga", rotulo: "Pilates e yoga" },
  { valor: "tatuagem", rotulo: "Tatuagem" },
  { valor: "petshop", rotulo: "Pet shop e banho e tosa" },
  { valor: "consultor", rotulo: "Professor ou consultor" },
